...
9. Quality checks for v3 passed locally:
   ...
   - `pnpm -s typecheck`
10. SSH access is restored (`deploy@<LEGACY_VPS_IP>` via `~/.ssh/id_ed25519`) and staging rollout for v3 is completed on release `20260227T110430Z-staging-v3.0.6-closeout`.
