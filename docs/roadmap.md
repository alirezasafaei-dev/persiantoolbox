...
**Version**: 6.8.0
**Status**: Active — Contract Tools MVP + Premium Export Complete
...
| شاخص        | مقدار                                                 |
| ----------- | ----------------------------------------------------- |
| ابزارها     | ۷۸ در ۷ دسته‌بندی                                     |
| مقالات بلاگ | ۵۴ مقاله باکیفیت                                      |
| تست‌ها      | ۶۵۸ — همه PASS                                        |
| OG Images   | ۱۰۰٪ پوشش                                             |
| صفحات SSG   | ۲۳۵+ صفحه                                             |
| API Routes  | ۴۹ مسیر                                               |
...
| قراردادها   | **اجاره مسکونی + پیمانکاری (MVP)**                    |
...
### ۳.۴ ابزارهای قرارداد — **تکمیل MVP ✅**

- [x] **قرارداد اجاره مسکونی** — wizard + فرم + پیش‌نمایش
- [x] **قرارداد پیمانکاری/معماری** — wizard + فرم + پیش‌نمایش
- [x] **Premium Export Pack** — DOCX + PDF (واترمارک + تمیز)
- [x] **Safe Clause Library** — ۲۰ بند پیش‌تایید شده (۱۰ اجاره + ۱۰ پیمانکاری)
- [x] **Draft History** — ذخیره خودکار + بارگذاری + حذف
- [x] **Local-first privacy** — تمام داده‌ها در مرورگر
- [x] **Legal disclaimer** — در تمام صفحات + قبل از دانلود
- [ ] **قالب‌های بیشتر** — خدمات، NDA، رسید دریافت وجه
- [ ] **اتصال پرداخت تکی** — Zarinpal برای خروجی حرفه‌ای
- [ ] **بازبینی حقوقی** — نیاز به وکیل برای تأیید بندها
- [ ] **تیم و فضای کاری مشترک** — برای آینده
