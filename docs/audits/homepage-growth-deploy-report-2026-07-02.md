...
The deployed homepage now leads with the free-tools message, keeps the «بیشتر از ۱۰۰ ابزار رایگان» wording consistent, and adds role-based paths so users can reach relevant tools faster.
...
- Homepage SEO/title/meta copy continues to emphasize «بیشتر از ۱۰۰ ابزار رایگان».
