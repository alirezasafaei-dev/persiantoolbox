...
- GitHub repository metadata در 2026-07-07 بازبینی شد و اکنون description،
  ...
  هستند.
- issue `#124` برای ساخت GitHub Project عمومی با ستون‌های `Now`, `Next`,
  `Later` باز است. این مورد در سطح ریپو آماده است اما در 2026-07-07 به دلیل
  scope ناکافی توکن GitHub CLI (`read:project`) هنوز از بیرون نهایی نشده است.
...
- GitHub repository metadata was reviewed on 2026-07-07 and now includes the
  ...
  `resume-builder`.
- Issue `#124` remains open for the public GitHub Project with `Now`, `Next`,
  and `Later` columns. Repo-side prep is complete, but as of 2026-07-07 the
  actual board creation is blocked by missing GitHub CLI token scope
  (`read:project`).
