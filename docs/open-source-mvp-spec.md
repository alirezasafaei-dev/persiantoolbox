...
- GitHub repository metadata را تکمیل کنید: description کوتاه، topics مثل
  `persian`, `rtl`, `nextjs`, `local-first`, `privacy`, `tools`, `pdf`,
  `jalali`.
...
- Complete GitHub repository metadata: short description and topics such as
  `persian`, `rtl`, `nextjs`, `local-first`, `privacy`, `tools`, `pdf`,
  `jalali`.
