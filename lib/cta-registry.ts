...
const offers: Record<CtaOfferId, CtaOffer> = {
  ...
  'audit-free-check': {
    ...
    destination: 'audit',
    emoji: '🔍',
    title: 'سایت داری؟ وضعیت فنی، سئو و امنیتش را جداگانه بررسی کن',
    subtitle: 'نمونه گزارش ASDEV Audit را ببین یا ارزیابی رایگان شروع کن',
    href: 'https://audit.alirezasafaeisystems.ir/sample-report',
    utmCampaign: 'audit',
    utmMedium: 'tool_result',
  },
  'toolbox-more-tools': {
