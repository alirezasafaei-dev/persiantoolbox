...
const DRAFT_STORAGE_KEY = 'persian-tools.contract-vehicle.v1';
...
export function saveDraft(draft: VehicleDraft): void {
...
export function loadDraft(id: string): VehicleDraft | undefined {
