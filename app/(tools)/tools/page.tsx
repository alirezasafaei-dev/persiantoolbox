...
export const metadata = buildMetadata({
  title: 'ابزارهای آنلاین رایگان فارسی - جعبه ابزار فارسی',
  description:
    'مجموعه کامل ابزارهای آنلاین رایگان فارسی: محاسبه مالی، PDF، تصویر، متن، تاریخ و اعتبارسنجی. تمام پردازش‌ها در مرورگر انجام می‌شود.',
  keywords: [
    'ابزار آنلاین',
    'ابزار رایگان',
    'محاسبه وام',
