    ...
    <SiteShell containerClassName="py-10">
      ...
      <div className="space-y-10">
        ...
        <section className="rounded-[var(--radius-lg)] border border-[var(--border-light)] bg-[var(--surface-1)] p-6 space-y-3">
          ...
          <p className="text-sm text-[var(--text-muted)] leading-7">
            سایت از سیاست امنیتی محتوای سخت‌گیرانه استفاده می‌کند. تمام درخواست‌های خارجی مسدود
            هستند. فقط ارتباط با سرور خود سایت مجاز است. این تضمین می‌کند هیچ داده‌ای بدون اطلاع شما
            به شخص ثالث ارسال نمی‌شود.
          </p>
